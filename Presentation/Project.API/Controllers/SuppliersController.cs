...
namespace Project.API.Controllers
{
    ...
    public class SuppliersController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetById(int id)
        {
            ...
            if (supplier == null)
                return NotFound(ApiResponse<SupplierDTO>.Fail("Tedarikçi bulunamadı."));
        ...
        public async Task<IActionResult> Create([FromBody] SupplierDTO dto)
        {
            ...
            if (!result.IsSuccess)
                return BadRequest(ApiResponse<string>.Fail($"Tedarikçi oluşturulamadı. Durum: {result}"));

            return CreatedAtAction(nameof(GetById), new { id = dto.Id }, ApiResponse<SupplierDTO>.Ok(dto, "Tedarikçi başarıyla oluşturuldu."));
        }
        ...
        public async Task<IActionResult> Update(int id, [FromBody] SupplierDTO dto)
        {
            ...
            if (original == null)
                return NotFound(ApiResponse<string>.Fail("Tedarikçi bulunamadı."));
            ...
            return Ok(ApiResponse<string>.Ok("Başarılı", "Tedarikçi başarıyla güncellendi."));
        }
        ...
        public async Task<IActionResult> SoftDelete(int id)
        {
            ...
            return Ok(ApiResponse<string>.Ok("Başarılı", "Tedarikçi silindi (soft delete)."));
        }
    }
}
