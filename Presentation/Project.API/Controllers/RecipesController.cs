...
namespace Project.API.Controllers
{
    ...
    public class RecipesController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetById(int id)
        {
            ...
            if (recipe == null)
                return NotFound(ApiResponse<RecipeDTO>.Fail("Reçete bulunamadı."));
        ...
        public async Task<IActionResult> Create([FromBody] RecipeDTO dto)
        {
            ...
            if (!result.IsSuccess)
                return BadRequest(ApiResponse<string>.Fail($"Reçete oluşturulamadı. Durum: {result}"));

            return CreatedAtAction(nameof(GetById), new { id = dto.Id }, ApiResponse<RecipeDTO>.Ok(dto, "Reçete başarıyla oluşturuldu."));
        }
        ...
        public async Task<IActionResult> Update(int id, [FromBody] RecipeDTO dto)
        {
            ...
            if (original == null)
                return NotFound(ApiResponse<string>.Fail("Reçete bulunamadı."));
            ...
            return Ok(ApiResponse<string>.Ok("Başarılı", "Reçete başarıyla güncellendi."));
        }
        ...
        public async Task<IActionResult> SoftDelete(int id)
        {
            ...
            return Ok(ApiResponse<string>.Ok("Başarılı", "Reçete silindi (soft delete)."));
        }
    }
}
